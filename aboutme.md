# about.me
This document is intended to give you a clear understanding about me, what my values are, what annoys me and what you can expect. It is also a tool for me to reflect on those aspects. I deliberately use git for this document, so that you are also able to see all changes to this document.
...
# biographic facts
I was born in December 1973 in a town called [Bamberg](https://en.wikipedia.org/wiki/Bamberg), which actually is very beautiful and makes me being at life level 44. My family runs a company there since 1677 (9 generations) which is now run by my brother. The company is in the beer industry, that's why I am pretty interested in beer culture (in addition to drink it).

After finishing Gymnasium (high school) there I immediately moved to [Karlsruhe](https://en.wikipedia.org/wiki/Karlsruhe) to study computer science. I am pretty proud that I actually got me a place at that university before I finished my Abitur (high school final exams). Back then Karlsruhe used (and still is) one of the best universities in Germany to study computer science and puts a strong focus on mathematics (I actually studied together with the mathematicians), algorithms and theories. 
...
At that time I was also chairman of Rotaract Germany, a junior devision of Rotary International and leading about 150 clubs and 3.500 members. 
By that social engagement I met a fascinating woman who lives in Hamburg and therefore I moved to that beautiful city. Today we are married and this was one of the best decisions I made.

In Hamburg I started working at an internet agency - SinnerSchrader - just before the first DotCom bubble exploded. I did the engineering work for several retail customers and started using Java for that.

After some time the two ex-founders of getgo.de approached me to create a new startup with me being in the role of a CTO. It turned out, this was not the only startup we founded and we become a serial startup company. Some startups were sold again, some were kept. All IT development was done in house and the team grew up to 8 engineers. However, I still kept coding and since there are not many people in a startup, I was team lead, architect, developer, sysadmin and dbadmin all in one.

As my second child was born I took a one year parental leave. During that time I got to know a couple, who was eager to found a company but was missing someone on the IT side. After the parental leave we three founded a company about customer satisfaction: we placed android tablets in retail stores and got continuous feedback from their end customers. I created all IT parts: the software, that runs on the android tablet, web-frontend, database, pdf export. In the 5 years I was with the company, we grew up to 14 employees and collected millions of customer feedback. However we had different opinions how to run the business and I left the company.

In February 2018 I joined XING as a team lead for the Spiderman team, aka ProBusiness in the blue business unit. Since 2019 I additionally lead the ProJobs team, which was created newly (or: re-created) and my main job is to ramp up the team. In 2020 the ProJobs team was merged with the Spiderman team into the ProDucks team. In 2021, management decided to re-create ProJobs and put a completely new team on it, leaving me with ProBusiness product only.

We are living in Hamburg Marienthal, my two kids are now 14 (female) and 9 (male) and they both attend school. My wife is an ex-project manager at DER SPIEGEL and now a freelance artist focusing on textile art. She is an award winning costume creator and works from home to give our kids and family a firm base until the kids leave our nest. She is my partner in crime and since we met we worked on social projects and other interesting ideas about the world we live in today. For example we attend the CCC hacker conferences together. 

I am writing this so detailed, because there are some key takeaways, that I want you to see:
...
Another part of the leadership job is to make sure, we are all aligned. Only if we are aligned and going in the same direction, we as a team and we as individuals are successful. (There is a great [talk by Dharmesh Shah](https://www.youtube.com/watch?v=i0yqJa48ebs) about that kind of alignment.)
...
If you have a different opinion than I, this is a welcomed topic to talk about with me.
...
Although we are doing a very technical job dealing with all those 0s and 1s, I strongly believe that in the end much boils down to our feelings and emotions. According to [this study (page 20)](https://static1.squarespace.com/static/53864718e4b07a1635424cdd/t/55de3d9ee4b07afa63281bf2/1440628126432/Apps+Alliance+Global+Developer+Insights+Report+2015.pdf), only 17% percent of IT projects fail because of technical reasons. Therefore I would like create an environment, where you feel safe to express your feelings and I give you support if you want to explore your emotions. 

## being open

I try hard to treat people as individuals and not to put them into drawers. I know that people have other believes than I have and they can keep their believes if they want to. If you want to talk with me about your believes, I will listen and not condemn you for having a different belief than I do (or that is "socially acceptable"). More likely I will try to understand as much as possible. 

## being honest

I try to be as open and honest as possible. On the other side, I give my best to be polite and will not say all my honesty directly "in your face". If you don't really understand, what I am saying, tell me.
...
What does that exactly mean? Let's boil it down: I have suffered from work situations, which haven't been good for me. From my past experience, a good or bad work place is not bound to the physical environment like tables, PC, etc. (it somehow is, but not that much as many people might think), but more to the people who I work with. So I envision a good work place as a place, where people are aware of each other. That does not necessarily mean, that they are nice to each other, but that they respect the other's needs. Mostly that boils down to the fact, that they respect and/or understand the other's feelings. This is what I mean by being aware of each other.
...
**I’m not good at your job.** You know best. I’ll work to provide necessary context and ask questions to help you vent your ideas but I won’t override you.
...
**You know best, what is good for you,** for your work and for your private life. If it is in conflict with me, the company, your environment or anything else, **I assume that you tell me**. It is ok to make mistakes, it is not ok to cover them up.

## one on ones (1:1)
The most important meeting will be our 1:1s. This is a regular meeting between just you and me. Length, frequency, format and content is up to you. We’ll start with 30 minutes bi-weekly and then adjust from there.
...
* Discuss this week, what went good for you, what did not. How did you feel about it? How you feel about our team and your teammates?
...
The best 1:1s I’ve had have focused beyond the moment: Your career development, team strategy and opportunity, the company's strategy, etc. Feel free to come with a topic you’d like to discuss.

1:1s should be a safe place. Everything that you tell me (if it is within the official 1:1 round or at some other occasion) is confidential by default and I won't tell anybody. If it comes to a case where I would need to share some information with others (e.g. my superior), I will tell you beforehand. I might also encourage you to share some information with the team, but this is then completely up to you.
...
Feedback works best, if given timely close to the occurrence. This applies for both kinds of feedback.
...
If you can give me feedback in-person, I'd prefer that - I will try the same. If you're only comfortable kicking off a discussion with an email or a Slack message, I would rather you do that than not bring it up at all.
...
You can approach me any time, except when I am in focus mode. **You don't have to wait until the next 1:1 is coming up.**
...
2. Slack me or email me. Even if you want an in-person meeting, just message me to let me know you want to talk and I'll make time. If you would rather talk about something over email or message, that's fine too. If I am in focus mode, I will have a red circle next to my status icon. I will not respond during that time, please try again later or wait a little time.
3. Throw something on my calendar. I am also a big fan of lunch dates. My calendar is well kept, please try to find an open spot there. I know, there are times with a lot of meetings, but there are also times with very few. If you cannot find an open spot, please approach me, e.g. via Slack.

If I'm working from home, you can expect me to be as available as I would be if I was in the office. Although it may feel weird to schedule a brief Slack call when you'd normally just swing by my desk for five minutes, please do so without hesitation if you think chatting face-to-face or screen-sharing will be more useful than textual communication.

You can also try to text me outside of the office hours and at the weekend. However, I will take care of myself and my family during that time and depending on my situation the response time might be very long.
...
Instead, I assume that you know, what is best for you (see above). I truely suggest for you to try to stay healthy and look for ways to find balance in your life. Actually, this is really important for me and I know that this sometimes can be really hard.
...
1. **Be on time.** I hate it to wait. If we have an appointment either be on time or cancel it beforehand.
...
3. **Be open.** I can only do my job, if you are open with me. If you try to hide something for me, chances are high, that in the end you won't get want you want.
...
## poker face
It is really hard to tell my emotions from my face. I always seem to have a nice, smiling, calm and relaxed face, no matter what my feelings are. My wife, for the most, is the person who can decipher my microexpressions properly, most others get it wrong. I'm getting better on balancing that by voicing my feelings more openly. However, especially when I don't feel so good, I also tend to speak less. 
...
I don't think, this is something you need to take care about, just something you need to be aware of, if you see me the first time.
...
I love to start new things but I often lose interest when I can envision, how the task is going to finish which might be weeks or months before the objective is actually done. If this takes place and you have a different opinion about the outcome, I would appreciate to hear about it.
...
I do a lot of photography. However I hardly use my DSLR any more and do mostly all my photos with my mobile phone (which I choose by the camera quality). 
